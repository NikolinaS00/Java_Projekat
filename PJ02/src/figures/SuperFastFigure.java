...
public class SuperFastFigure extends Figure {
	...
	File icon = new File("." + File.separator + "in" + File.separator + "zzzz.png");
	
	public SuperFastFigure(Color c) {
		this.color = c;
	}

	public void colorField(Integer position) {

		Logger.getLogger(SuperFastFigure.class.getName()).addHandler(Main.handler);
		...
		try {
			...
			Logger.getLogger(SuperFastFigure.class.getName()).log(java.util.logging.Level.SEVERE, e.fillInStackTrace().toString());
		}
	...
	public String toString() {
		...
		return this.Name + " " + "(" + DescriptionOfMove.colorName(this.color) + ", super brza figura ) - prijedjeni put " + s + " - stigla do cilja ( " + stigla + ")";
	}
